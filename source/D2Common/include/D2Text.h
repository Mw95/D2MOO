...
D2COMMON_DLL_DECL short __stdcall TEXT_GetStringIdOfMenuType0Node(D2TextHeaderStrc* pTextHeader, int nNodeId);
//D2Common.0x6FDC3890 (#10908)
D2COMMON_DLL_DECL short __stdcall TEXT_GetStringIdOfMenuType1Node(D2TextHeaderStrc* pTextHeader, int nNodeId);
