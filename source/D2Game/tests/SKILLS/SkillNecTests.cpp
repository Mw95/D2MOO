...
TEST_SUITE("SkillNecTests")
{
	...
	TEST_CASE_FIXTURE(NoopFixture, "D2Game.0x6FD0B3D0" * doctest::skip(""))
	{
		...
		SUBCASE("")
		{
			...
			// Call both implementations
			const auto moo_result = sut(&moo_pUnit, nStatId, nResist);
			const auto original_result = original(&original_pUnit, nStatId, nResist);
	...
	TEST_CASE_FIXTURE(NoopFixture, "D2Game.0x6FD0B450" * doctest::skip(""))
	{
		...
		SUBCASE("")
		{
			...
			// Call both implementations
			const auto moo_result = sut(&moo_pUnit, moo_pArgs);
			const auto original_result = original(&original_pUnit, original_pArgs);
	...
	TEST_CASE_FIXTURE(NoopFixture, "D2Game.0x6FD0C2E0" * doctest::skip(""))
	{
		...
		SUBCASE("")
		{
			...
			const auto setup_data = []() {
				...
				return std::tuple{ pUnit, pPet };
			};
			
			// Input data
			auto [moo_pUnit, moo_pPet] = setup_data();
			auto [original_pUnit, original_pPet] = setup_data();
	...
	TEST_CASE_FIXTURE(NoopFixture, "D2Game.0x6FD0C530" * doctest::skip(""))
	{
		...
		SUBCASE("")
		{
			...
			// Call both implementations
			const auto moo_result = sut(&moo_pGame, &moo_pUnit, &moo_pPet, nSkillId, nSkillLevel, nItemLevel);
			const auto original_result = original(&original_pGame, &original_pUnit, &original_pPet, nSkillId, nSkillLevel, nItemLevel);
	...
	TEST_CASE_FIXTURE(NoopFixture, "D2Game.0x6FD0CB10" * doctest::skip(""))
	{
		...
		SUBCASE("")
		{
			...
			// Call both implementations
			const auto moo_result = sut(&moo_pGame, &moo_pUnit, &moo_pPet, nPetLevelArg, nSkillLevel);
			const auto original_result = original(&original_pGame, &original_pUnit, &original_pPet, nPetLevelArg, nSkillLevel);
	...
	TEST_CASE_FIXTURE(NoopFixture, "D2Game.0x6FD0DF40" * doctest::skip(""))
	{
		...
		SUBCASE("")
		{
			...
			const auto setup_data = []() {
				...
				return std::tuple{ pGame, pUnit, pMonster };
			};
			
			// Input data
			auto [moo_pGame, moo_pUnit, moo_pMonster] = setup_data();
			auto [original_pGame, original_pUnit, original_pMonster] = setup_data();
			int32_t nSkillId{};
			int32_t nSkillLevel{};
	...
	TEST_CASE_FIXTURE(NoopFixture, "D2Game.0x6FD0F590" * doctest::skip(""))
	{
		...
		SUBCASE("")
		{
			...
			// Call both implementations
			const auto moo_result = sut(&moo_pUnit, nValue);
			const auto original_result = original(&original_pUnit, nValue);
