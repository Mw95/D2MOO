...
TEST_SUITE("A2IntroTests")
{
	const auto working_directory = std::filesystem::current_path();
	const auto dll_base = reinterpret_cast<uintptr_t>(LoadLibraryA((working_directory / "D2Game.dll").string().c_str()));

	
	TEST_CASE_FIXTURE(NoopFixture, "D2Game.0x6FC9F120" * doctest::skip(""))
	{
		// Set up function pointers
		const auto [sut, original] = make_function_pair(ACT2Intro_InitQuestData, dll_base + 0x0006F120);
	...
	TEST_CASE_FIXTURE(NoopFixture, "D2Game.0x6FC9F180" * doctest::skip(""))
	{
		// Set up function pointers
		const auto [sut, original] = make_function_pair(ACT2Intro_Callback11_ScrollMessage, dll_base + 0x0006F180);
	...
	TEST_CASE_FIXTURE(NoopFixture, "D2Game.0x6FC9F260" * doctest::skip(""))
	{
		// Set up function pointers
		const auto [sut, original] = make_function_pair(ACT2Intro_Callback00_NpcActivate, dll_base + 0x0006F260);
